...
[قائمة تشغيل YouTube لكل قسم]()

# جدول المحتويات


<details>
<summary>الموارد</summary>
<ol>
<li><a href="#blockchain-developer-smart-contract--solidity-course---powered-by-ai---beginner-to-expert-course--foundry-edition-2023"> الدورة الشاملة لتطوير سوليدتي</a></li>
<li><a href="#جدول-المحتويات">جدول المحتويات</a>
  <ul>
    <li><a href="#الأدوات-الموصى-بها">الأدوات الموصى بها</a></li>
  </ul>
</li>
<li><a href="#صنابير-Testnet">صنابير Testnet</a></li>
<li><a href="#موارد-هذه-الدورة-التدريبية">موارد هذه الدورة التدريبية</a></li>
</ol>
</details>
<details>
<summary> <a href="#lesson-0-welcome-to-the-course">الدرس 0: مرحبًا بك في الدورة التدريبية!</a></summary>
<ol>
  <li>
  <a href="#welcome-to-the-course">مرحبًا بك في الدورة التدريبية! </أ>
  </li>
</ol>
</details>
...
<ol>
    <li><a href="#مقدمة">المقدمة</a></li>
    <li><a href="#إعداد-عقدك-الأول">إعداد عقدك الأول</a></li>
    <li><a href="#أساسيات-سوليدتي:-الأنواع">أساسيات سوليدتي: الأنواع</a></li>
    <li><a href="#أساسيات-سوليدتي:-الوظائف">أساسيات سوليدتي: الوظائف</a></li>
    <li><a href="#أساسيات-سوليدتي:-المصفوفات-والهياكل">أساسيات سوليدتي: المصفوفات & الهياكل</a></li>
    <li><a href="#أساسيات-سوليدتي:-أخطاء-وتحذيرات-المترجم">أساسيات سوليدتي: أخطاء وتحذيرات المترجم</a></li>
    <li><a href="#memory-storage-calldata-intro">الذاكرة والتخزين وبيانات المكالمات (مقدمة)</a></li>
    <li><a href="#التعيينات">التعيينات</a></li>
    <li><a href="#نشر-عقدك-الأول">نشر عقدك الأول</a></li>
    <li><a href="#ملخص-الدرس-الأول">ملخص الدرس الأول</a></li>
</ol>
</details>
<details>
<summary><a href="#الدرس-2:-مصنع-تخزين">الدرس 2: مصنع تخزين</a></summary>
<ol>
    <li><a href="#مقدمة-1">المقدمة</a></li>
    <li><a href="#أساسيات-سوليدتي:-استيراد-العقود-إلى-عقود-أخرى">أساسيات سوليدتي: استيراد العقود إلى عقود أخرى</a></li>
    <li><a href="#أساسيات-سوليدتي:-التفاعل-مع-العقود-الأخرى">أساسيات سوليدتي: التفاعل مع العقود الأخرى</a></li>
    <li><a href="#أساسيات-سوليدتي:-الوراثة-والتجاوزات">أساسيات سوليدتي: الميراث & التجاوزات</a></li>
    <li><a href="#ملخص-الدرس-2">ملخص الدرس الثاني</a></li>
  </ol>
</details>
<details>
<summary>
<a href="الدرس-3:Fund-Me">الدرس 3:Fund Me</a>
  ...
  <ol>
    <li><a href="#مقدمة-2">المقدمة</a></li>
    <li><a href="#setup">الإعداد</a></li>
    <li><a href="#sending-eth-through-a-function">إرسال ETH من خلال وظيفة</a></li>
    <li><a href="#reverts">المرتجعون</a></li>
    <li><a href="#getting-real-world-price-data-chainlink">الحصول على بيانات الأسعار العالمية الحقيقية (Chainlink)</a></li>
    <li><a href="#quick-recap-i">الملخص السريع الأول</a></li>
    <li><a href="#interfaces">الواجهات</a></li>
    <li><a href="#ai-help-iii">مساعدة الذكاء الاصطناعي III</a></li>
    <li><a href="#importing-from-npm--github">الاستيراد من NPM / GitHub</a></li>
    <li><a href="#getting-prices-from-chainlink">الحصول على الأسعار من Chainlink</a></li>
    <li><a href="#more-solidity-math">المزيد من رياضيات الصلابة</a></li>
    <li><a href="#msgsender">msg.sender</a></li>
    <li><a href="#quick-recap-ii">الملخص السريع II</a></li>
    <li><a href="#library">المكتبة</a></li>
    <li><a href="#safemath">SafeMath</a></li>
    <li><a href="#for-loop">للحلقة</a></li>
    <li><a href="#resetting-an-array">إعادة تعيين مصفوفة</a></li>
    <li><a href="#transfer-send-and-call">التحويل والإرسال والاتصال</a></li>
    <li><a href="#المنشئ">المنشئ</a></li>
    <li><a href="#المعدلات">المعدلات</a></li>
    <li><a href="#testnet-demo">العرض التجريبي لـTestnet</a></li>
    <li><a href="#advanced-solidity">الصلابة المتقدمة</a>
      <ul>
        <li><a href="#immutable--constant">غير قابل للتغيير & ثابت</a></li>
        <li><a href="#custom-errors">الأخطاء المخصصة</a></li>
        <li><a href="#receive--fallback-functions">تلقي & الوظائف الاحتياطية</a></li>
      </ul>
    </li>
  </ol>
</details>
